...
builder.Services.Configure<BusinessShareOptions>(builder.Configuration.GetSection(BusinessShareOptions.SectionName));
...
builder.Services.AddScoped<IBusinessShareService, BusinessShareService>();
...
END");
    ...
    {
        logger.LogWarning(ex, "Could not ensure business share schema. Run Scripts/EnsureBusinessShareSchema.sql if needed.");
    }
