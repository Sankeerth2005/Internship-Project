...
class HomeCategoryChips extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final itemCount = 1 + displayedCategories.length;
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final label = cat.categoryName;
              final catIcon = categoryIconResolver(label);
              ...
              return GestureDetector(
                onTap: () {
                  ...
                  if (isSelected) {
                    ...
                    onCategoryChanged(cat.categoryId);
                  }
                },
                child: AnimatedScale(
